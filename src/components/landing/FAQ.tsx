...
export function FAQ({ companyName = "SMMplan" }: { companyName?: string }) {
  const FAQ_ITEMS = [
    ...
    },
    {
      ...
      a: 'Да, наша платформа предоставляет скидки по промокодам и полностью документированное API для автоматической интеграции. Вы можете получить свой персональный API-ключ в настройках профиля после первой авторизации.',
    },
    {
