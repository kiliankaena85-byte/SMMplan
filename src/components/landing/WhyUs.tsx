  ...
  return (
    <section aria-labelledby="why-us-heading" className="mx-auto max-w-6xl px-4 py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[280px]">
        ...
        {/* Card 2: Small Span */}
        <div className="md:col-span-1 bg-slate-900 dark:bg-content2 rounded-[2rem] p-8 relative overflow-hidden group hover:shadow-2xl hover:shadow-indigo-500/20 transition-all duration-300">
          ...
          <div className="relative z-10 flex flex-col h-full">
            <div className="w-12 h-12 bg-white/10 dark:bg-primary/10 rounded-2xl flex items-center justify-center mb-6 text-indigo-300 group-hover:scale-110 transition-transform">
              <IconTrendingUp className="w-6 h-6" stroke={1.5} />
            </div>
            <h3 className="text-xl font-bold text-white mb-3">Оптовые цены</h3>
            <p className="text-white/70 dark:text-muted-foreground font-medium leading-relaxed">
        ...
        {/* Card 3: Small Span */}
        <div className="md:col-span-1 bg-content1 rounded-[2rem] p-8 relative overflow-hidden group border border-border/50 hover:shadow-2xl hover:shadow-emerald-500/10 transition-all duration-300">
          <div className="relative z-10 flex flex-col h-full">
        ...
        {/* Card 4: Large Span */}
        <div className="md:col-span-2 bg-content1 rounded-[2rem] p-8 relative overflow-hidden group border border-border/50 hover:shadow-2xl hover:shadow-rose-500/10 transition-all duration-300">
