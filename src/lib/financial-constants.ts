...
/** Верхний предел разумной себестоимости закупки (RUB за 1000 единиц) для защиты от валютных аномалий: 500 000 ₽/1k (= 500 ₽/шт) */
export const UPPER_SANITY_LIMIT_RUB = 500000;
