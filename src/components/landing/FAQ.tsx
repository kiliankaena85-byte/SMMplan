...
export function FAQ({ companyName = "Smmplan" }: { companyName?: string }) {
  const FAQ_ITEMS = [
    ...
    },
    {
      ...
      a: `Нет. Мы ценим ваше время. При первой покупке просто укажите email — ${companyName} автоматически сгенерирует для вас безопасный личный кабинет бизнес-класса.`,
    },
    {
