...
## Активный статус: 💎 Проведен полный рефакторинг экрана «Финансы & Касса» (/admin/finance) на 4 чистые вкладки без наложений виджетов. Ликвидировано задвоение селекторов сайтов по всей админ-панели: GlobalSiteSwitcher в Header зафиксирован как единственный источник правды.
