  ...
  return (
    <section aria-labelledby="why-us-heading" className="mx-auto max-w-6xl px-4 py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[280px]">
        ...
        {/* Card 1: Large Span */}
        <div className="md:col-span-2 bg-card rounded-[2rem] p-8 relative overflow-hidden group border border-border hover:shadow-2xl hover:shadow-primary/10 transition-all duration-300">
          ...
          <div className="relative z-10 flex flex-col h-full h-full">
            ...
            <h3 className="text-2xl font-bold text-card-foreground mb-3">AI-подбор услуг</h3>
        ...
        {/* Card 2: Small Span */}
        <div className="md:col-span-1 bg-foreground rounded-[2rem] p-8 relative overflow-hidden group hover:shadow-2xl hover:shadow-indigo-500/20 transition-all duration-300">
          ...
          <div className="relative z-10 flex flex-col h-full">
            <div className="w-12 h-12 bg-background/10 rounded-2xl flex items-center justify-center mb-6 text-indigo-300 group-hover:scale-110 transition-transform">
              <IconTrendingUp className="w-6 h-6" stroke={1.5} />
            </div>
            <h3 className="text-xl font-bold text-background mb-3">Оптовые цены</h3>
        ...
        {/* Card 3: Small Span */}
        <div className="md:col-span-1 bg-card rounded-[2rem] p-8 relative overflow-hidden group border border-border hover:shadow-2xl hover:shadow-emerald-500/10 transition-all duration-300">
          <div className="relative z-10 flex flex-col h-full">
            <div className="w-12 h-12 bg-emerald-50 rounded-2xl flex items-center justify-center mb-6 text-emerald-500 group-hover:scale-110 transition-transform dark:bg-emerald-500/10">
              <IconShieldCheck className="w-6 h-6" stroke={1.5} />
            </div>
            <h3 className="text-xl font-bold text-card-foreground mb-3">Прозрачные условия</h3>
        ...
        {/* Card 4: Large Span */}
        <div className="md:col-span-2 bg-card rounded-[2rem] p-8 relative overflow-hidden group border border-border hover:shadow-2xl hover:shadow-rose-500/10 transition-all duration-300">
           <div className="absolute bottom-0 left-0 w-full h-1/2 bg-gradient-to-t from-rose-50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 dark:from-rose-500/10" />
           <div className="relative z-10 flex flex-col justify-end h-full">
            <div className="w-12 h-12 bg-rose-50 rounded-2xl flex items-center justify-center mb-6 text-rose-500 group-hover:scale-110 transition-transform dark:bg-rose-500/10">
              <IconDiamond className="w-6 h-6" stroke={1.5} />
            </div>
            <h3 className="text-2xl font-bold text-card-foreground mb-3">Программа лояльности VIP</h3>
