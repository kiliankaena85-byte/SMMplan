      ...
      <div className="w-full lg:w-[400px] bg-slate-900 border-t lg:border-t-0 lg:border-l border-slate-800 p-8 flex flex-col justify-between shrink-0 no-print z-20">
        ...
        <div className="mt-8 space-y-4">
          <button
            ...
            className="w-full h-12 bg-sky-500 hover:bg-sky-400 text-white font-bold uppercase tracking-wider text-xs rounded-xl shadow-lg shadow-sky-500/15 flex items-center justify-center gap-2.5 transition-all active:scale-[0.98]"
          >
