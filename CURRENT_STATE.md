...
## Активный статус: 💎 Устранены 4 инцидента в поддержке: ликвидирован полупрозрачный дубликат сообщений, настроено безопасное HTML-экранирование и fallback для Telegram-доставки, устранено наложение статусов в шапке тикета, и расширено меню шаблонов (Zero Clipping).
