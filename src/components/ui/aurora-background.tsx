...
export const AuroraBackground = ({
  ...
  return (
    <main>
      <div
        className={cn(
          "relative flex flex-col items-center justify-center bg-slate-900 text-slate-50 transition-bg",
          className
        )}
        {...props}
      >
        <div className="absolute inset-0 overflow-hidden">
          <div
            //   We generate a beautiful pseudo-aurora using overlapping tailwind gradients with a background-size configuration
            className={cn(
              `
            ...
            [--aurora:repeating-linear-gradient(100deg,var(--color-sky-500)_10%,var(--color-indigo-300)_15%,var(--color-sky-300)_20%,var(--color-violet-200)_25%,var(--color-sky-400)_30%)]
