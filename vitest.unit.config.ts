...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      'src/__tests__/security/tenant-audit-isolation.test.ts',
      'src/__tests__/security/worker-tenant-guard.test.ts',
      'src/__tests__/telemetry/p0-alert-debouncer-reconnect.test.ts',
      'src/__tests__/security/webhook-rate-limiter.test.ts',
