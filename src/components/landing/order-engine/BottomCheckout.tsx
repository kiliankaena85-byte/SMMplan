...
export function BottomCheckout({ engine, handleCheckout, isSubmitting }: BottomCheckoutProps) {
  ...
  return (
    <div className="sm:hidden bg-content2 border-t border-border/50 p-6 flex flex-col gap-8 rounded-b-[2.5rem]">
      {/* Link Input Row */}
         ...
         <div className="space-y-3">
            ...
            <div className="relative">
              ...
              <input 
                ...
                placeholder="https://..."
                className="w-full h-16 pl-14 pr-6 rounded-full border-2 border-border bg-content1 shadow-sm text-[15px] font-semibold text-foreground placeholder-slate-400 focus:bg-content1 focus:border-primary/50 focus:shadow-[0_8px_20px_-6px] focus:shadow-primary/15 outline-none transition-all"
              />
            </div>
         </div>
      </div>
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
         ...
         <div className="space-y-3">
            ...
            <input 
              ...
              className="w-full h-16 px-6 rounded-full border-2 border-border bg-content1 shadow-sm text-xl font-black tabular-nums text-foreground focus:bg-content1 focus:border-primary/50 focus:shadow-[0_8px_20px_-6px] focus:shadow-primary/15 outline-none transition-all"
            />
         </div>
      </div>

      {/* Bottom row with price and button */}
      <div className="w-full flex flex-col md:flex-row items-center justify-between gap-6 pt-6 border-t border-border">
         ...
         <div className="flex items-center gap-3 order-2 md:order-1">
           ...
           <p className="text-[12px] text-muted-foreground font-medium leading-tight max-w-[250px]">
             Я принимаю условия <Link href="/p/offer" className="underline text-foreground hover:text-primary transition-colors">Оферты</Link> и <Link href="/p/privacy" className="underline text-foreground hover:text-primary transition-colors">Политики конфиденциальности</Link>
           </p>
         </div>
      ...
      <div className="w-full flex justify-end mt-3 md:mt-2">
         <p className="text-[11px] text-muted-foreground font-medium max-w-[250px] text-right leading-tight">Оплата картой (РФ) и СБП. Оплата криптовалютой доступна в Личном Кабинете.</p>
      </div>
    </div>
  );
}
