...
5. **Referral Cash Out Exploit Assessment**:
   ...
   - If the user has already transferred and spent the commission, the subtraction makes the `referralBalance` negative (e.g. `-500` rubles). The user retains the transferred main balance, resulting in a direct financial loss to the platform.
