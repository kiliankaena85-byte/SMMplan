...
- [ ] Логи консоли браузера Playwright зафиксированы и не содержат JS-ошибок/исключений во время кликов по соцсетям и категориям.
...
- [ ] Высота всех кликабельных областей in `MobileWizard` на экранах шириной 375px составляет не менее 44px.

## 2026-05-23T08:08:28Z
...
- Проверить полный цикл оформления заказа неавторизованным клиентом через форму `SmartOrderForm` с выбором ЮKassa:
  ...
  3. Симуляция успешного платежа через вебхук `/api/webhooks/yookassa` with передачей корректных метаданных.
...
## 2026-05-24T08:13:32Z

Доведение административной панели Smmplan до 100% уровня зрелости (Production-Ready) с акцентом на модернизацию вкладки «Маркетинг», повышение финансовой безопасности «Докруток», улучшение поиска в «Каталоге» и внедрение премиальных UI/UX элементов по Stripe/Vercel стандартам.
