...
|---|------|-------|-------------|--------|
| 1 | Explore & Map Infrastructure | Scan existing tests, configs, Playwright specs, mock systems, and verify current state. | None | DONE (13223a74-b012-4e82-aa88-7f11af09f3be) |
| 2 | R1: Real Provider & Catalog Integration | Implement and supplement integration tests for SMM providers & CBR rates synchronization (with real internet access). | M1 | DONE (0ed96309-dd23-4942-9301-acef83e59471) |
| 3 | R2: Payment Gateways API Verification | Implement tests verifying real API calls (YooKassa, Robokassa, CryptoBot), test keys rollback, and empty credentials fallback. | M1 | DONE (6b64a003-877c-4a53-93c1-a56cbc67f568) |
| 4 | R3: Playwright E2E User Flow Tests | Develop or update E2E tests for password/magic auth, unit pricing display, link validator categories, and checkout/balance deduction. | M1 | IN_PROGRESS (56a8ff0b-32d5-4014-aed6-0b430ed1d5d4) |
| 5 | R4: Playwright E2E Admin Panel Tests | Test admin login, provider setup, service import, markup settings, quarantine logic, and AdminAuditLog logging. | M1 | IN_PROGRESS (56a8ff0b-32d5-4014-aed6-0b430ed1d5d4) |
| 6 | R5: Queue & SLA Worker Tests | Cover BullMQ workers (OrderProcessor, SyncProcessor) with queue/SLA checks and Prisma transaction rollback stress tests. | M1 | DONE (6b64a003-877c-4a53-93c1-a56cbc67f568) |
