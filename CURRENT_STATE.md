...
## Активный статус: 🚀 Успешный пуш в origin/main. Завершена реализация контура защиты персональных данных (GDPR / 152-ФЗ Compliance): прозрачное AES-256-GCM шифрование чувствительных полей (Encryption at Rest), детерминированное хеширование для поиска, сервис профиля с защитой от IDOR, безопасное удаление аккаунтов (Right to be Forgotten) с анонимизацией и сохранением финансовых леджеров на 5 лет, журнал доступа операторов к ПДн (Access Log) и фоновая очистка устаревших логов (Data Retention Job), тесты 45/45 passed.
