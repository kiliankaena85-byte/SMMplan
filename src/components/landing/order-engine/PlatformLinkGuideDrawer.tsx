  ...
  telegram: {
    ...
    steps: [
      ...
      },
      {
        ...
        desc: "Копирование ссылки на конкретное фото из галереи отличается на разных телефонах:\n\n• 📱 На iPhone (iOS): Зажмите и удерживайте пальцем нужное фото прямо в посте ➔ В открывшемся меню выберите «Копировать ссылку» (или нажмите стрелочку «Поделиться» ➔ «Скопировать ссылку»).\n\n• 🤖 На Android: Нажмите на конкретное фото в посте, чтобы открыть его на весь экран ➔ В правом верхнем углу нажмите на три точки «⋮» ➔ Выберите «Копировать ссылку».\n\nПолученная ссылка будет иметь вид с ?single на конце (например, t.me/durov/123?single).",
        imgPlaceholder: "iPhone: зажмите фото ➔ Скопировать | Android: фото на весь экран ➔ три точки ⋮ ➔ Скопировать"
      }
    ]
  },
  instagram: {
