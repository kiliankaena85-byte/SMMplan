...
> **Последнее обновление:** 2026-09-03 10:35 (МСК) — Конструктор Telegram-ботов OmniSMM, мульти-ботовая платформа (Multi-Bot Manager), 5 готовых пресетов, визуальный редактор шагов и переходов (BotFlowBuilder), автомиграция основного бота и полная интеграция в админ-панель (Ветка `tg_bot_castom`).
