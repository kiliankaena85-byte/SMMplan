...
interface StaffRoleWithPermissions extends StaffRole {
  permissions: { id: string; name: string; section: string; canView: boolean; canEdit: boolean }[];
}
...
interface TeamManagementProps {
  ...
  staffRoles?: StaffRoleWithPermissions[];
}
